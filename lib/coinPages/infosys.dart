              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      infoquantity = int.parse(quantityController.text);
                      InfoQ.setInt(InfoQ.infoquantity + infoquantity);
...
class InfoQ {
  static int infoquantity = 0;

  static void setInt(int newValue) {
    infoquantity = newValue;
  }
