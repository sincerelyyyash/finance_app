              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      axisquantity = int.parse(quantityController.text);
                      AxisQ.setInt(AxisQ.axisquantity + axisquantity);
...
class AxisQ {
  static int axisquantity = 0;

  static void setInt(int newValue) {
    axisquantity = newValue;
  }
