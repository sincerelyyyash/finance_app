...
class KOTAKpage extends StatefulWidget {
  ...
  @override
  State<KOTAKpage> createState() => _KOTAKpageState();
}
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ktkquantity = int.parse(quantityController.text);
                      KtkQ.setInt(KtkQ.ktkquantity + ktkquantity);
...
class KtkQ {
  static int ktkquantity = 0;

  static void setInt(int newValue) {
    ktkquantity = newValue;
  }
