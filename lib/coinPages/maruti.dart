...
class MARUTIpage extends StatefulWidget {
  ...
  @override
  State<MARUTIpage> createState() => _MARUTIpageState();
}
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      mrtiquantity = int.parse(quantityController.text);
                      MrtiQ.setInt(MrtiQ.mrtiquantity + mrtiquantity);
...
class MrtiQ {
  static int mrtiquantity = 0;

  static void setInt(int newValue) {
    mrtiquantity = newValue;
  }
