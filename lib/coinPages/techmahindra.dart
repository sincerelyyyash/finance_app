...
class TECHMpage extends StatefulWidget {
  const TECHMpage({super.key});

  @override
  State<TECHMpage> createState() => _TECHMpageState();
}

class _TECHMpageState extends State<TECHMpage> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      tecmqty = int.parse(quantityController.text);
                      TecmQ.setInt(TecmQ.tecmqty + tecmqty);
